    ...
    <body>
        <div class="navigation">
            <nav id="nav-bar">
                ...
                <ul class="nav-component" style="width: 40%">
                    <li><a href="home">Home</a></li>
                        <c:if test="${sessionScope.account != null}">
                        <li><a href="companyManager">Company Manager</a></li>
                        <li><a href="showApply">Application</a></li>
                        </c:if>
                </ul>

                <c:if test="${sessionScope.account != null}">
                    <div class="contain-user" style="width: 60%">
                        <input style="padding:10px 20px; border-radius: 10px; margin-left: 50px" type="text" name="search" value="${requestScope.search}" id='search' oninput="searchName()">Search
                ...
                <c:if test="${sessionScope.account == null}">
                    <div class="contain-user" style="width: 48%">
                            <input style="padding:10px 20px; border-radius: 10px" type="text" name="search" value="${requestScope.search}" id='search' oninput="searchName()">Search
                ...
                <div id="list-hotel">
                    ...
                    <c:forEach items="${listPost}" var="p">
                        <a href="apply?postId=${p.id}" class="hotel" style="padding: 0; width: 21%">
                            <img src="${mapCompany.get(p.companyId).img}" alt="">
                            ...
                            <label style="font-size: 13px; color: #545454; align-items: center; margin-top: 10px;">
                                ...
                                ${mapCompany.get(p.companyId).location}
                            </label>
            ...
            <div class="contain-hotel" style="width: 100%; margin: 0 auto;">
                ...
                <div id="list-hotel">
                    ...
                    <c:forEach items="${listCompany}" var="c">
                        <a href="showPostByCompany?companyId=${c.id}" class="hotel2" style="padding: 0; width: 21%">
                            <img src="${c.img}" alt="">
                ...
                <div style="width: 100%">
                    <ul class="paging" style="text-align: center">
                        <c:forEach begin="1" end="${Math.ceil(listCompany.size()/8)}" var="i">
